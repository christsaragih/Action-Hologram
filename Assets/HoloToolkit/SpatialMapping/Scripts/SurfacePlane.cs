...
namespace Academy.HoloToolkit.Unity
{
    ...
    public class SurfacePlane : MonoBehaviour
    {
        ...
        private void SetPlaneType()
        {
            ...
            CommonStatic.floorYPosition = floorYPosition;
            CommonStatic.WasUpdate = true;
            ...
            if (SurfaceNormal.y >= UpNormalThreshold)
            {
                ...
                Vector3 extents = plane.Bounds.Extents ;
                gameObject.transform.localScale = new Vector3(extents.x, extents.y, PlaneThickness);
                gameObject.transform.position = new Vector3(gameObject.transform.position.x, floorYPosition, gameObject.transform.position.z);
            }
            ...
            this.gameObject.name = PlaneType+"";
